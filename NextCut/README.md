<p>
    1. Install laravel: Please check the official laravel installation guide for server requirements before you start. &emsp;&emsp;(https://laravel.com/docs/8.x/installation) <br/> <br/>
